...
singleton1 = as.numeric(names(which(table(z1_samples.post.burn) <= 0.00 * n1)))
...
singleton2 = as.numeric(names(which(table(z2_samples.post.burn) <= 0.00 * n2)))
...
singleton3 = as.numeric(names(which(table(z3_samples.post.burn) <= 0.00 * n3)))
...
singleton4 = as.numeric(names(which(table(z4_samples.post.burn) <= 0.00 * n4)))
...
singleton5 = as.numeric(names(which(table(z5_samples.post.burn) <= 0.00 * n5)))
...
singleton6 = as.numeric(names(which(table(z6_samples.post.burn ) <= 0.00 * n6)))
...
singleton7 = as.numeric(names(which(table(z7_samples.post.burn) <= 0.00 * n7)))
...
singleton8 = as.numeric(names(which(table(z8_samples.post.burn) <= 0.00 * n8)))
